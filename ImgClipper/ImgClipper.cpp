    ...
    : QMainWindow(parent)
{
    helpTextEdit.setMarkdown(
		...
		"|---|---|\n"
		"|f1|Open this help|\n"
		"|p or ctrl+v|Push clipboard image to the list and display it|\n"
		"|right or l|Move to the next image in the list|\n"
		"|left or h|Move to the previous image in the list|\n"
		"|z or +|Zoom in and switch to zoom mode|\n"
		"|x or -|Zoom out and switch to zoom mode|\n"
		"|t|Always on top|\n"
		"|s or w|Save all list images to the picture folder|\n"
		...
		"|z or +|Zoom in|\n"
		"|x or -|Zoom out|\n"
		"|right or l|Move image to the right|\n"
		"|left or h|Move image to the left|\n"
		"|up or k|Move image up|\n"
		"|down or j|Move image down|\n"
		"|tab|Toggle frameless window|\n"
        );
